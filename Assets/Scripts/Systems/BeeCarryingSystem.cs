...
public class BeeCarrying : SystemBase
{
    ...
    protected override void OnUpdate()
    {
        ...
        Entities
                .ForEach( ( int entityInQueryIndex, Entity bee, in Translation translation, in IsCarryingResource carrying, in TargetPosition targetPosition ) =>
            {
                ...
                if(d < 1)
                {
                    ...
                    ecb.AddComponent<CompleteDelivery>( entityInQueryIndex, carrying.Value );
                    ecb.SetComponent<Translation>( entityInQueryIndex, carrying.Value, translation );
                    
                    // revert to idle
                    ecb.RemoveComponent<IsCarryingResource>( entityInQueryIndex, bee );
